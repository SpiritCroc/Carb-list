...
public abstract class CustomPreferenceFragment extends PreferenceFragment
    ...
    protected void setEditTextPreferenceSummary(String key) {
        EditTextPreference preference = (EditTextPreference) findPreference(key);
        setEditTextPreferenceSummary(preference);
    }

    protected void setEditTextPreferenceSummary(EditTextPreference preference) {
